...
//altfp_mult CBX_AUTO_BLACKBOX="ALL" DEDICATED_MULTIPLIER_CIRCUITRY="YES" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone V" EXCEPTION_HANDLING="NO" PIPELINE=11 REDUCED_FUNCTIONALITY="NO" ROUNDING="TO_NEAREST" WIDTH_EXP=8 WIDTH_MAN=23 clk_en clock dataa datab nan overflow result underflow zero
...
`endif
	...
	assign
		...
		zero = zero_ff;
endmodule //fp_mult_altfp_mult_f0r
//VALID FILE
...
module fp_mult (
	...
	fp_mult_altfp_mult_f0r	fp_mult_altfp_mult_f0r_component (
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
				.datab (datab),
